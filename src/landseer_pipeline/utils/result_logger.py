    ...
    def log_combination(self, combination, tools_by_stage, dataset_name, dataset_type, acc, duration, status: str):
        ...
        with open(self.combinations_csv, "a", newline='') as f:
            ...
            if not file_exists:
                ...
                "ood_auc", "fingerprinting", "asr", "privacy_epsilon", "dp_accuracy", "watermark_accuracy", "mia_auc", "drop10_score", "total_duration", "combination_status"
                ])
            writer.writerow([
            ...
            round(asr, 4), str(privacy_epsilon), str(dp_acc), round(watermark_acc, 4), round(mia_auc, 4), round(drop10_score, 4), round(duration, 2), status
            ])